...
class PredefinicaoLema : AppCompatActivity() {
    ...
    private lateinit var editTextLema: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnPagHome = findViewById(R.id.btnPagHome5)
        btnCruz = findViewById(R.id.btnMensagensSemana5)
        btnMais = findViewById(R.id.btnFlutuante5)
        btnMenu = findViewById(R.id.btnMenu)
        btnSalvar = findViewById(R.id.btnSalvar)
        editTextTitulo = findViewById(R.id.etTituloLema)
        editTextData = findViewById(R.id.etDataLema)
        editTextLema = findViewById(R.id.etTextoLema)
        ...
        if (caminhoFoto != null) {
            ...
            if (file.exists() && file.length() > 0) {
                Glide.with(this)
                    ...
                    .into(imgPerfil)
                Log.d("PredefinicaoLema", "Foto carregada no menu: $caminhoFoto")
            } else {
                Log.w("PredefinicaoLema", "Foto não encontrada no menu, usando padrão")
